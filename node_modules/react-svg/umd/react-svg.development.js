(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('prop-types'), require('react'), require('react-dom/server')) :
	typeof define === 'function' && define.amd ? define(['prop-types', 'react', 'react-dom/server'], factory) :
	(global.ReactSVG = factory(global.PropTypes,global.React,global.ReactDOMServer));
}(this, (function (PropTypes,React,ReactDOMServer) { 'use strict';
	...
	function (_React$Component) {
	  ...
	  _proto.render = function render() {
	    var _this$props2 = this.props,
	        ...
	        rest = objectWithoutPropertiesLoose(_this$props2, ["evalScripts", "fallback", "loading", "onInjected", "renumerateIRIElements", "src", "svgClassName", "svgStyle", "wrapper"]);

	    var Wrapper = wrapper;
	    return React.createElement(Wrapper, _extends_1({}, rest, {
